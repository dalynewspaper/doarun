    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          Obx(() => StandardInput(
              errorStr:
                  onboardingStates.isGroupNameFieldValid.value ? null : "",
          ...
          Obx(() => StandardInput(
              ...
              errorStr:
                  !onboardingStates.isKmTargetFieldValid.value ? "" : null,
              onChanged: (String value) {
                if (value.isNotEmpty)
                  try {
          ...
          TextButton(
              ...
              onPressed: () async {
                if (groupStates.group.value.name.isEmpty ||
                  ...
                  if (!Get.isSnackbarOpen)
                    Get.snackbar(
                        "Sorry :(", "This group name is already taken!");
                } else {
                  groupStates.group.value.accounts
                      .add(accountStates.account.uid);
